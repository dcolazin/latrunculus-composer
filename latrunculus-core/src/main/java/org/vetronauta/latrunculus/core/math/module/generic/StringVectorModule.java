 ...
 * @author vetronauta
 */
public class StringVectorModule<R extends RingElement<R>> extends VectorModule<StringMap<R>> {


    public StringVectorModule(StringRing<R> ring, int dimension) {
        super(ring, dimension);
    }

    @Override
    public StringRing<R> getRing() {
        return (StringRing<R>) super.getRing();
    }
