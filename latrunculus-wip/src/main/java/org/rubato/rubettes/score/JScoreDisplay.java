...
public class JScoreDisplay
    ...
    static {
        playImage  = Icons.loadIcon(ScorePlayRubette.class, "/images/rubettes/score/play.png").getImage();
        pauseImage = Icons.loadIcon(ScorePlayRubette.class, "/images/rubettes/score/pause.png").getImage();
