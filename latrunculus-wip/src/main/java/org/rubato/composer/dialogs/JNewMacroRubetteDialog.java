...
public final class JNewMacroRubetteDialog extends JDialog implements ActionListener {
    ...
    public JNewMacroRubetteDialog(Frame frame) {
        super(frame, DialogsMessages.getString("JNewMacroRubetteDialog.newmacrorubette"), true);
        ...
        namePanel.setBorder(makeTitledBorder(DialogsMessages.getString("JNewMacroRubetteDialog.name")));
        ...
        infoPanel.setBorder(makeTitledBorder(DialogsMessages.getString("JNewMacroRubetteDialog.info")));
        ...
        shortDescPanel.setBorder(makeTitledBorder(DialogsMessages.getString("JNewMacroRubetteDialog.shortdescription")));
        ...
        longDescPanel.setBorder(makeTitledBorder(DialogsMessages.getString("JNewMacroRubetteDialog.longdescription")));
        ...
        cancelButton = new JButton(DialogsMessages.getString("JNewMacroRubetteDialog.cancel"));
        cancelButton.addActionListener(this);
        buttonPanel.add(cancelButton);
        okButton = new JButton(DialogsMessages.getString("JNewMacroRubetteDialog.ok"));
