...
public final class IdentifyAction implements Action2D {
    ...
    private void identifyPoint(int screenX, int screenY) {
        ...
        org.rubato.composer.view2d.Point nextPt = null;
        for (org.rubato.composer.view2d.Point pt : view.getPoints()) {
    ...
    private final Cursor infoCursor = View2D.loadCursor(IdentifyAction.class, "/images/composer/view2d/infocursor.png", 7, 7);
}
