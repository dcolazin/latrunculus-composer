...
public class Selection {
    ...
    public List<org.rubato.composer.view2d.Point> getPoints() {
        return points;
    }
    ...
    public void addRealPoint(double x, double y) {
        org.rubato.composer.view2d.Point pt = new SelectionPoint(x, y);
    ...
    public void moveSelectedPoint(int screenX, int screenY) {
        if (selectedPoint >= 0 && selectedPoint < points.size()) {
            org.rubato.composer.view2d.Point pt = points.get(selectedPoint);
            pt.screenX = screenX;
            pt.screenY = screenY;
    ...
    public boolean contains(org.rubato.composer.view2d.Point pt) {
    ...
    private class SelectionPoint extends org.rubato.composer.view2d.Point {
