 ...
 * @see PolynomialFreeElement
 * 
 * @author Gérard Milmeister
 */
public interface PolynomialFreeModule<E extends ModuleElement<E,PolynomialElement<B>>, B extends RingElement<B>> extends FreeModule<E,PolynomialElement<B>> {
