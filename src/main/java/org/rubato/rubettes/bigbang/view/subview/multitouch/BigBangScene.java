...
public class BigBangScene extends AbstractScene {
	...
	private void makeButtonsLayer(MTApplication mtApplication, ViewController controller) {
		...
		this.makeButton(mtApplication, "/images/rubettes/bigbang/navModeIcon.png", 0, new DisplayModeAction(controller, new MTNavigationModeAdapter(controller, this)));
		this.makeButton(mtApplication, "/images/rubettes/bigbang/transModeIcon.png", 75, new DisplayModeAction(controller, new MTTransformationModeAdapter(controller, this)));
	}
